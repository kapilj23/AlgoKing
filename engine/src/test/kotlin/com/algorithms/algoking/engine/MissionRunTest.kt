...
import com.algorithms.algoking.engine.challenge.Boundary
import com.algorithms.algoking.engine.challenge.ChallengeGenerator
import com.algorithms.algoking.engine.challenge.Comparison
import com.algorithms.algoking.engine.challenge.Difficulty
import com.algorithms.algoking.engine.challenge.HintAccess
import com.algorithms.algoking.engine.challenge.MissionRun
import com.algorithms.algoking.engine.challenge.MissionStep
import com.algorithms.algoking.engine.challenge.Verdict
import com.algorithms.algoking.engine.core.Dataset
import com.algorithms.algoking.engine.scenario.Mission
import com.algorithms.algoking.engine.scenario.MissionCatalog
import com.algorithms.algoking.engine.scenario.MissionKind
...
class MissionRunTest {
    ...
    fun `no hint ever contains the answer`() {
        ...
        MissionStep.entries.forEach { step ->
            com.algorithms.algoking.engine.challenge.MissionHints.forStep(step)?.forEach { hint ->
...
private typealias MissionHints = com.algorithms.algoking.engine.challenge.MissionHints
