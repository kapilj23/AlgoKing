...
import com.algorithms.algoking.engine.algorithms.binarysearch.BinarySearchAction
import com.algorithms.algoking.engine.algorithms.binarysearch.BinarySearchAlgorithm
import com.algorithms.algoking.engine.algorithms.binarysearch.BinarySearchState
...
import com.algorithms.algoking.engine.challenge.HintPolicy
...
class MissionChallengeTest {
    ...
    fun `relabelling a mission never changes what is correct`() {
        val plain = MissionCatalog.build(
            kind = com.algorithms.algoking.engine.scenario.MissionKind.WAREHOUSE,
            difficulty = com.algorithms.algoking.engine.challenge.Difficulty.Intermediate,
            seed = 11L,
        )
    ...
    private fun solve(values: List<Int>, target: Int): Run {
        val runner = AlgorithmRunner(
            ...
            com.algorithms.algoking.engine.core.Dataset(values, target),
        )
        var decisions = 0
        var guard = 0
        while (guard++ < 256) {
