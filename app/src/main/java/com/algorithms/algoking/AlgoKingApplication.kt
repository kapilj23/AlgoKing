...
import com.algorithms.algoking.ads.ConsentManager
import com.algorithms.algoking.ads.InterstitialAds
...
class AlgoKingApplication : Application() {
     ...
     * ([com.algorithms.algoking.ads.AdPolicy.mayRequestAds]); this only guarantees that
